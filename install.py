...
# MariaDB 설치
mariadb_install = subprocess.Popen(shlex.split("apt-get -y install mariadb-server"), stdout=subprocess.PIPE, stdin=subprocess.PIPE)
#stdout, stderr = mariadb_install.communicate(b"\n")
print(mariadb_install.stdout.read())
